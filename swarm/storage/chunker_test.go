...
//这个测试可以验证文件到一个相对较短的长度，因为树分块器会大大减慢速度。
//较长文件的验证由testlocalstore完成，并在swarm包中进行检索。
//尺寸：=[]int 1、60、83、179、253、1024、4095、4096、4097、8191、8192、8193、12287、12288、12289、524288、524288+1、524288+4097、7*524288、7*524288+1、7*524288+4097
...
//func基准点拆分图3_8（t*testing.b）基准点拆分图3（100000000，t）
...
//func基准拆分树b t_8（t*testing.b）基准拆分树b t（100000000，t）
...
//func基准拆分金字塔3_8（t*testing.b）基准拆分金字塔3（100000000，t）
...
//func基准点拆分金字塔bmt_8（t*testing.b）基准点拆分金字塔bmt（100000000，t）
...
//通过测试-超时20M-CPU 4-工作台=/Swarm/存储-运行编号
//如果不在上面添加超时参数..基准将超时并转储
