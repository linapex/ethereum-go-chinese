...
//如果我们运行的是轻型客户端或服务器，则强制启用v5对等机发现
...
//registerethstattsservice配置ethereum stats守护进程并将其添加到
//给定节点。
